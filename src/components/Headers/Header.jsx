                    ...
                    <CardBody>
                      <Row>
                        <div className="col">
                          ...
                          <span className="h2 font-weight-bold mb-0">XYZ COMPANY</span>
                        </div>
                        <Col className="col-auto">
                      ...
                      <p className="mt-3 mb-0 text-muted text-sm">
                        ...
                        <span className="text-nowrap">Life Beyond the coding</span>
                      </p>
                    </CardBody>
                  </Card>
                </Col>
                  ...
                  <Card className="card-stats mb-4 mb-xl-0">
                    <CardBody>
                      ...
                      <p className="mt-3 mb-0 text-muted text-sm">
                        ...
                        <span className="text-nowrap">Go Ahead</span>
                      </p>
                    </CardBody>
                  </Card>
                </Col>
